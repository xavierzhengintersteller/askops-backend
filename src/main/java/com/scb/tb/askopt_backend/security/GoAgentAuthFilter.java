...
import com.scb.tb.askopt_backend.config.Hmac.HmacProperties;
import com.scb.tb.askopt_backend.config.Hmac.HmacSigner;
...
public class GoAgentAuthFilter implements Filter {
    ...
    private void writeErr(HttpServletResponse resp, int code, String msg) throws IOException {
        ...
        resp.setStatus(code);
        resp.setHeader(TraceFilter.TRACE_ID_HEADER,
                MDC.get(TraceFilter.MDC_TRACE_KEY));
